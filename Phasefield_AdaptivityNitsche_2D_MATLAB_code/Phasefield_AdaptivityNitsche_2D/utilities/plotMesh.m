function varargout = plotMesh(X,T,w,option,nodesNum)
...
patchHandle = patch('Faces',patchFaces,'Vertices',X,'FaceColor','none','EdgeAlpha',w,'LineWidth',0.8,'EdgeColor','black');
axis image
...
if nargin > 3
    ...
    if strcmpi(option,'plotNodes')
        plot(X(:,1),X(:,2),'.','markerSize',3,'markerFaceColor','b')
...
switch nOfElementNodes
    ...
    case 16 %Q3
        res = [1 9 8 16; 16 7 6 15; 15 5 4 14; 14 3 2 1];
%         res = [1 5 6 2; 2 7 8 3; 3 9 10 4; 4 11 12 1];
    case 21 %P5
        res = [1 4:7 2; 2 8:11 3; 3 12:15 1];
    case 25 %Q4
        res = [1 13 12 11 25; 25 10 9 8 24; 24 7 6 5 23; 23 4 3 2 1];
